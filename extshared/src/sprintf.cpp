...
/*
NOTICE: This file has been modified from the original source to be usable
        outside of the "sourcemod logic" binary.
        Edited by rtldg...
        CTRL+F "//EDIT" to find what's changed...
		In atcprintf, %L, %T, and %t have been disabled, mainly.
*/

//EDIT #include "common_logic.h"
//EDIT #include "Translator.h"
#include <logic/sprintf.h>
#include <am-float.h>
#include <am-string.h>
//EDIT #include <IDBDriver.h>
//EDIT #include <ITranslator.h>
//EDIT #include <bridge/include/IScriptManager.h>
//EDIT #include <bridge/include/CoreProvider.h>
...
//EDIT IDatabase *g_FormatEscapeDatabase = NULL;
...
#if 1 //EDIT START
					IGamePlayer* player;
					if (!(player = playerhelpers->GetGamePlayer(*value)) || !*(name = player->GetName()))
#else
