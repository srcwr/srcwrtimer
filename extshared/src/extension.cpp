...
PLATFORM_EXTERN_C void cpp_build_path(char* buf, size_t bufsize, const char* friendly_path, SourceMod::PathType ty)
{
	smutils->BuildPath(ty, buf, bufsize, "%s", friendly_path);
}
